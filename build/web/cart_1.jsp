       ...
       <%
           ...
           %>   
               <tr>
                   ...
                   <td><a href="Productsdetails_1.jsp?PID=<%=rs.getString(1)%>"><%=rs.getString(2)%></a></td>
                   ...
                   <td><a href="removecart_1.jsp?removeval=<%=rs.getString(1)%>"><button class="button button1" style="padding: 10px; alignment-adjust: central;">Remove</button></a></td> 
               </tr>
           <% }
...
//           while(rs1.next())
//           {
//               total = total + Integer.parseInt(rs1.getString(3).trim());  // Fethches all the Prices from cart as we require total of all cart products
//               Quantity = Quantity + Integer.parseInt(rs1.getString(4).trim());
//           }
//           rs.close();
//           rs1.close();
           %>
           ...
           <td colspan="5">
               <a href="Products_1.jsp"><button style=" margin:-2px;" class="button button1">Back</button></a>
               <a href="cart2_1.jsp"><button style=" position: relative;" class="button button1">BUY</button></a>
               <!--<a href="ProductSlip_1.jsp?Quant=1"><button style=" position: relative;" class="button button1">BUY</button></a>-->        
           </td> 
           </table>
    </body> 
</html>
